 ...
 */
contract TokenAdmin is IBalancerTokenAdmin, SingletonAuthentication, ReentrancyGuard {
    using Math for uint256;

    // Initial inflation rate of 1.3731M tokens per week.
    uint256 public constant override INITIAL_RATE = (1373100 * 1e18) / uint256(1 weeks); // BAL has 18 decimals
